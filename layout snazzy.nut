...
class UserConfig {
	...
	</ label="Left Side Art", help="Enable Left Side Art", options="Yes,No", order=7 /> enable_leftart_snazzy="No";
	...
	</ label="Enable Flyer Art", help="Enable Flyer Art", options="Yes,No", order=14 /> enable_bigart3_snazzy="No";
	...
	</ label="Wheel Layout", help="Select wheel type", options="List Box,Horizontal,Horizontal Animated,Vertical Wheel", order=19 /> enable_list_snazzy="Vertical Wheel";
...
local framebg = fe.add_image("black.png", flx*0.3, fly*0.28, flw*0.4, flh*0.55)
...
local video = fe.add_image( fe.get_art("snap"),flx*0.3, fly*0.28, flw*0.4, flh*0.55);  //Use add_image so the snap doesn't auto-update while navigating
...
local snap = FadeArt( "snap", flx*0.3, fly*0.28, flw*0.4, flh*0.55)
...
//Frame
if ( my_config["enable_frame"] == "Yes") {
local frame = fe.add_image("frame.png", flx*0.3, fly*0.28, flw*0.4, flh*0.55)
...
/////////////////////////////////////////////////////
if ( my_config["enable_leftart_snazzy"] == "Yes" ){
...
//////////
if ( my_config["enable_leftart_snazzy"] == "Yes" ){
if ( my_config["enable_systemimage_snazzy"] == "Yes" ){	
...
//Overlay
if ( my_config["enable_list_snazzy"] == "Vertical Wheel" )
{
...
if (( my_config["enable_list_snazzy"] == "Horizontal"  ) || ( my_config["enable_list_snazzy"] == "Horizontal Animated") || ( my_config["enable_list_snazzy"] == "Horizontal Boxart")){
...
if (( my_config["enable_list_snazzy"] == "Vertical Wheel"  ) || ( my_config["enable_list_snazzy"] == "List Box")){
...
local wheelImage = fe.add_image( "wheel" ,flx + bbm, bth - floor( wheelImageH / 2 ), wheelImageW, wheelImageH )
...
local category = fe.add_text("", categoryX, categoryY, categoryW, categoryH )
...
local categoryLeft = fe.add_text("", 0, categoryY, categoryW, categoryH )
...
local categoryRight = fe.add_text("", 0, categoryY, categoryW, categoryH )
...
local categoryLeft2 = fe.add_text("", 0, categoryY, categoryW, categoryH )
...
local categoryRight2 = fe.add_text("", 0, categoryY, categoryW, categoryH )
...
function on_transition( ttype, var, ttime ) {
	...
	if ( my_config["enable_list_snazzy"] == "List Box" ){
			gameListBoxAnimX.to = flw + flx - crw - lbw
...
mfliter2 = fe.add_text( "Snazzy View", 0, flh*0.4, fe.layout.width, mfliter2H ),
}
